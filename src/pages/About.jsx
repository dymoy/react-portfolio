    ...
    return (
        <section id="about" className='section d-flex justify-content-between align-items-center'>
            <div id="about-content-container" className="col-md-7 text-dark">
                ...
                <p>I am currently pursuing a certificate for Web Development at the <i>University of Texas at Austin</i>. I enjoy building web tools that enhance the way we interact with online content and our community; and am looking to develop innovative full-stack projct for your organization.</p>
